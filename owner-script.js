...
function saveAccommodation(event) {
    ...
    const facilitiesInput = document.getElementById("facilitiesInput").value;
    const picturesInput = document.getElementById("picturesInput").value;
    ...
    const data = {
        ...
        // Ensure facilities and pictures are arrays and stringify them correctly
        facilities: JSON.stringify(facilitiesInput.split(",")),
        pictures: JSON.stringify(picturesInput.split(",")),
